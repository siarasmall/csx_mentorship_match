...
class Mentor:
    def __init__(self, name: str, email: str, grade: str, classInterest: int, researchInterest: int, industryInterest: int, gradInterest: int, pivotInterest: int, mentees: List[Mentee]):
        self.name = name
        self.email = email
        self.grade = grade
    ...
    def addMentee(self, mentee: Mentee):
